...
const pricingPlans = [
  { name: 'Basic', price: 500, cards: 20, color: 'bg-blue-500' },
  { name: 'Standard', price: 1000, cards: 50, color: 'bg-green-500' },
  { name: 'Premium', price: 2000, cards: 100, color: 'bg-purple-500' }
];
